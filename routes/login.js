...
router.use(session({
    secret: 'congthao11', // Thay 'your-secret-key' bằng một chuỗi bí mật thực sự
    resave: false,
    saveUninitialized: true,
    store: MongoStore.create({ mongoUrl: 'mongodb://127.0.0.1:27017/ComicManager' }) // Sử dụng MongoStore để lưu session vào MongoDB
}));
/* GET users listing. */
